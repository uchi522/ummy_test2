  ...
  return (
    <aside className="w-64 bg-white border-r-[1.5px] border-[#1E293B]/20 flex flex-col h-full shrink-0 overflow-y-auto pt-6 pb-4 px-3 hidden lg:flex">
      <div className="mb-8 px-3">
        <button className="w-full bg-[#10B981] hover:bg-[#0e9f6e] text-white border-[1.5px] border-[#1E293B] shadow-[3px_3px_0px_#1E293B] hover:translate-y-[1px] hover:translate-x-[1px] hover:shadow-[2px_2px_0px_#1E293B] transition-all rounded-xl py-2.5 flex items-center justify-center gap-2 font-bold text-sm">
          <Plus size={18} />
          新規スレッド
        </button>
      </div>
